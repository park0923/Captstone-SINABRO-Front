    ...
    const [data, setData] = useState({
      ...
      const handlePaging = (number) =>{     
        if(states === ""){          
          axios({
            method: 'get',
            url: 'http://54.219.63.255:8080/api/works?page='+ number + '&size=10',            
            headers: {                
                "Authorization": 'Bearer ' + cookies
            }            
          })
          ...
          axios({
            method: 'get',
            url: 'http://54.219.63.255:8080/api/works?page='+ number +'&searchOption=title&keyword=' + searchdata,            
            headers: {                
                "Authorization": 'Bearer ' + cookies
            }            
          })
          ...
          axios({
            method: 'get',
            url: 'http://54.219.63.255:8080/api/works?page='+ number +'searchOption=title_contents&keyword='+ searchdata,            
            headers: {                
                "Authorization": 'Bearer ' + cookies
            }            
          })
      ...
      const handleSubmit = (e) => {      
        if(selectvalue === "title"){          
          axios({
            method: 'get',
            url: 'http://54.219.63.255:8080/api/works?searchOption=title&keyword=' + searchdata,            
            headers: {                
                "Authorization": 'Bearer ' + cookies
            }            
          })
          ...
          axios({
            method: 'get',
            url: 'http://54.219.63.255:8080/api/works?searchOption=title_contents&keyword='+ searchdata,            
            headers: {                
                "Authorization": 'Bearer ' + cookies
            }            
          })
