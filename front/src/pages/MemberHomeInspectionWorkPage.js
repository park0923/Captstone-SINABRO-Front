...
function MemberHomeInspectionWorkPage(){
    return(
        <div className="min-h-screen flex item-center justify-between bg-gray-yellow py-8 px-4 sm:px-6 lg:px-8">            
            ...
            <div className="p-10 item-center max-w-screen-lg space-y-1">     
                <div className="flex flex-row ">
                    <div className="p-6 boder border-2 shadow-md rounded-xl item-center justify-center w-150 h-35 bg-gray-50 ">
                        <h3 className="text-left text-lg font-sebang-gothic front-bold text-black">[도서] 달러구트 꿈 백화점 전자화 요청</h3>
                        <p className="text-center text-sm font-sebang-gothic front-normal text-black">달러구트 꿈 백화점 도서를 음성으로 들을 수 있도록 e-book 처럼 전자 자료로 제작 부탁드립니다.</p>    
                    </div>
                </div>
                <div className="flex flex-row space-x-4 justify-between" >
                    {/* <div className="flex flex-col mt-10">
                        <div className="flex flex-row justify-between">
                            <h1 className="py-4 text-2xl font-sebang-gothic front-bold text-black">자료 예시</h1>           
                        </div>
                        <div className="w-72 y-20 h-96 border-2 shadow-md rounded-xl item-center justify-center bg-gray-50">
                            <img className="w-72 y-64 h-96" src="/img/book.png" alt="book" />                                
                        </div>
                    </div> */}
                    <div className="flex flex-col mt-10">
                        <div className="flex flex-row justify-between">
                            <h1 className="py-2 text-2xl font-sebang-gothic front-bold text-black">작업 진행 공간</h1>           
                        </div>
                        ...
                        {/* <div className="w-72 y-40 h-64 border-2 shadow-md rounded-xl item-center justify-center bg-gray-50 ">
                            <h1>내용</h1>
                            <textarea id="content" name="story"rows="5" cols="33"> </textarea>
                            <h2>날짜</h2>
                            <textarea id="date" name="story"rows="1" cols="33"> </textarea>
                            <h3>검수자</h3>
                            <textarea id="inspection" name="story"rows="1" cols="33"> </textarea>
                        </div> */}
                        ...
                        <div className="w-full h-36 border-2 shadow-md rounded-xl item-center justify-center bg-gray-50 ">
                            <p className="p-2 text-left text-sm font-sebang-gothic front-normal text-black"></p>
                            <textarea id="content" name="content" rows="5" cols="90">
                               
                            </textarea>
                        </div>
                        
                        {/* <div className="space-y-2 w-72 y-40 h-20 border-2 shadow-md rounded-xl item-center justify-center bg-gray-50 mt-2 ">
                            <p className="p-2 text-left text-sm font-sebang-gothic front-normal text-black">1. 못핸 - 못한으로 수정 필요</p>
                            <p className="p-2 text-left text-sm font-sebang-gothic front-normal text-black">2. '간결하게'라는 문구가 빠짐</p>
                        </div> */}
