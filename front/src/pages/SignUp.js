...
//   axios
//     .post("http://13.57.232.44:8080/api/members/signup", {
...
function SignUp() {
  ...
  const onSubmit = () => {    
    if(authority === "1"){
      axios.post('http://13.57.232.44:8080/api/members/signup', {
            username: name,
            password: password,
            email: email,
          })          
      ...
      axios.post('http://13.57.232.44:8080/api/members/beneficiary/signup', {
            username: name,
            password: password,
            email: email,
          })          
