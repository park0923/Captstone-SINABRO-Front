...
//   axios
//     .post("http://54.153.86.50:8080/api/members/signup", {
...
function SignUp() {
  ...
  const onSubmit = () => {    
    if(authority === "1"){
      axios.post('http://54.153.86.50:8080/api/members/signup', {
            username: name,
            password: password,
            email: email,
          })          
      ...
      axios.post('http://54.153.86.50:8080/api/members/beneficiary/signup', {
            username: name,
            password: password,
            email: email,
          })          
