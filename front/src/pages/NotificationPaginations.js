...
const NotificationPaginations = (props) => {    
    ...
    const handlePaging = (number) =>{     
      if(states === ""){
        axios.get('http://18.117.247.55:8080/api/boards?page='+ number + '&size=10')
        .then(function (response) {
            // handle success            
            setData(response.data);
          })
        ...
        axios.get('http://18.117.247.55:8080/api/boards?page='+ number +'&searchOption=title&keyword=' + searchdata)
        .then(function (response) {
            // handle success
            setData(response.data);            
          })
        ...
        axios.get('http://18.117.247.55:8080/api/boards?page='+ number +'searchOption=title_contents&keyword='+ searchdata)
        .then(function (response) {
            // handle success
            setData(response.data);
          })
