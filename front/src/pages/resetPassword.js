            ...
            <div className="my-20 p-10 border-2 shadow-md rounded bg-gray-50 max-w-md w-full min-h-full space-y-8">
                <div>
                    ...
                    <p className="mt-3 text-center text-base font-noto-sans font-medium text-gray-900">
                        e-mail 주소를 입력해주세요. 입력한 주소로 암호를 재설정 할 수 있는 링크를 받을 수 있습니다.
                    </p>                    
                </div>
                <form className="mt-8 space-y-6">
                    <div>
                        <label htmlFor="email" className="text-gray-900 font-sans text-sm font-semibold">Email</label>
                        <input type="email" required name="userEmail" placeholder="이메일" value={""} onChange={""} className="my-1 appearance-none rounded-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded focus:outline-none focus:ring-green-500 focus:border-green-500 focus:z-10 sm:text-sm"/>
                    </div>
                    <div>
                ...
                <div className="flex items-center justify-around">
                    ...
                    <div className="text-sm">
                        <Link to="/user/signup" className="font-medium font-noto-sans text-green-600 hover:text-green-400">
                            회원가입
                        </Link>
                    </div>                    
                </div>        
