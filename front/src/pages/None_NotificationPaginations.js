...
const None_NotificationPaginations = (props) => {
  ...
  const handlePaging = (number) => {
    if (states === "") {
      axios
        .get(
          "http://54.153.86.50:8080/api/boards?page=" + number + "&size=10"
        )
        .then(function (response) {
          // handle success
          setData(response.data);
      ...
      axios
        .get(
          "http://54.153.86.50:8080/api/boards?page=" +
            number +
  ...
  const handleSubmit = (e) => {
    if (selectvalue === "title") {
      axios
        .get(
          "http://54.153.86.50:8080/api/boards?searchOption=title&keyword=" +
            searchdata
        )
        .then(function (response) {
          // handle success
      ...
      axios
        .get(
          "http://54.153.86.50:8080/api/boards?searchOption=title_contents&keyword=" +
            searchdata
        )
        .then(function (response) {
          // handle success
