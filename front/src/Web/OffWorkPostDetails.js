...
const OffWorkPostDetails = ({history, location, match}) => {
    ...
    useEffect(() => {
        axios({
            method: 'get',
            url: 'http://52.79.155.65:8080/api/offVolunteer/' + id,     
            headers: {                
        ...
        // axios({
        //     method: 'get',
        //     url: 'http://52.79.155.65:8080/api/offVolunteer/download/' + id,     
        //     headers: {                
        //         "Authorization": 'Bearer ' + cookies
        //     }                           
        //   })
    ...
    const apply = () =>{ 
        ...
        if(cookies === null || cookies === undefined){
            ...
            axios.post(                 
                'http://52.79.155.65:8080/api/offVolunteerApplication/' + id,
                form                
                )
              .then(function (response) {
                // handle successF
