...
const ApplicantList = () => {
    ...
    useEffect(() => {
        axios({
            method: 'get',
            url: 'http://54.153.86.50:8080/api/approval/volunteerWorks',     
            headers: {                
    ...
    const handlePage = (value) => {
        ...
        axios({
            method: 'get',
            url: 'http://54.153.86.50:8080/api/approval/volunteerWorks?page=' + pages,     
            headers: {                
                "Authorization": 'Bearer ' + cookies
            }                           
          })
    ...
    const handlePermit = (idx) => {        
        ...
        axios({
            method: 'patch',
            url: 'http://54.153.86.50:8080/api/approval/volunteerWorks/permit/' + id,     
            headers: {                
                "Authorization": 'Bearer ' + cookies
            }                           
          })
    ...
    const handleRefuse = (idx) => {
        ...
        axios({
            method: 'patch',
            url: 'http://54.153.86.50:8080/api/approval/volunteerWorks/refuse/' + idx,     
            headers: {                
                "Authorization": 'Bearer ' + cookies
            }                           
          })
